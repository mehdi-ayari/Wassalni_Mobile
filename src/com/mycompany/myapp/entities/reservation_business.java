...
public class reservation_business {
    private int id_res_business,user_id_entreprise;
    private Date date_depart,date_reservation;
    private String destination,nom_client_entreprise,prenon_client_entreprise,point_depart;

    public reservation_business(int id_res_business, int user_id_entreprise, Date date_depart, Date date_reservation, String destination, String nom_client_entreprise, String prenon_client_entreprise, String point_depart) {
    ...
    public reservation_business(int user_id_entreprise, Date date_depart, Date date_reservation, String destination, String nom_client_entreprise, String prenon_client_entreprise, String point_depart) {
        this.user_id_entreprise = user_id_entreprise;
        this.date_depart = date_depart;
        this.date_reservation = date_reservation;
        this.destination = destination;
